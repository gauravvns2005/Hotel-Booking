...
function Dashboard() {
  ...
  const getStatusBadge = (status, payStatus) => {
    ...
    if (payStatus === "paid") return <span className="badge badge-success">Confirmed & Paid</span>;
  ...
  return (
    <div className="dashboard-page page-wrapper">
      <div className="container">
        ...
        {successMsg && (
          <div style={{ background: "rgba(34,197,94,0.1)", border: "1px solid var(--success)", color: "var(--success)", borderRadius: "8px", padding: "0.75rem 1rem", marginBottom: "1.5rem" }}>
            {successMsg}
          </div>
        )}
                ...
                <div className="booking-content">
                  <div className="booking-top">
                    <div>
                      ...
                      <p className="booking-location">📍 {b.hotel?.city}</p>
                    </div>
                  ...
                  <div className="booking-meta">
                    ...
                    <div className="meta-item">
                      ...
                      <span>{new Date(b.checkIn).toLocaleDateString("en-IN", { dateStyle: "medium" })}</span>
                    </div>
                    <div className="meta-item">
                      <span className="meta-label">Check-Out</span>
                      <span>{new Date(b.checkOut).toLocaleDateString("en-IN", { dateStyle: "medium" })}</span>
                    </div>
                    <div className="meta-item">
                  ...
                  <div className="booking-footer">
                    <span className="booking-price">₹{b.totalPrice?.toLocaleString()}</span>
                    {b.bookingStatus !== "cancelled" && (
                      <button className="btn btn-sm btn-danger" onClick={() => cancelBooking(b._id)}>
                        Cancel Booking
                      </button>
                    )}
                  </div>
