...
function Wishlist() {
  ...
  const removeFromWishlist = async (hotelId) => {
    try {
      ...
      setList((prev) => prev.filter((item) => item.hotel?._id !== hotelId));
    } catch {}
  };
  ...
  return (
    <div className="wishlist-page page-wrapper">
      <div className="container">
        ...
        <p className="section-subheading">Hotels you&apos;ve saved for later</p>

        {list.length === 0 ? (
          <div className="no-wishlist">
            <span style={{ fontSize: "3rem" }}>💝</span>
            <h3>Your wishlist is empty</h3>
            <p>Explore hotels and click the heart icon to save your favorites</p>
          </div>
        ) : (
